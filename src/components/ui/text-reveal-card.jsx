    ...
    (<div
      ...
      <div className="h-40 relative flex items-center overflow-hidden">
        <motion.div
          ...
          className="absolute bg-[#e9feb9] z-20  will-change-transform">
          <p
            style={{
              textShadow: "4px 4px 15px rgba(0,0,0,0.5)",
            }}
            className="text-base sm:text-[3rem] py-10 font-bold text-black bg-clip-text">
            {revealText}
          </p>
        </motion.div>
        <motion.div
        ...
        <div
          ...
          <p
            className="text-base sm:text-[3rem] py-10 font-bold bg-clip-text text-black">
            {text}
          </p>
          <MemoizedStars />
        </div>
